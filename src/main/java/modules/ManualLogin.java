...
public class ManualLogin {
  ...
  public void logIn(WebDriver driver, LoginDetail loginDetail) throws InterruptedException, IOException {
    PropertyReader propertyReader = new PropertyReader();
    final String baseURL = propertyReader.getProperty(propertyReader.BASE_URL);
